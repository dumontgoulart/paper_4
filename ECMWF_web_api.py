...
#     date_list=pd.date_range('2007-01-01','2007-01-02', # 2007 start of total precip
...
#         for time in times:
#             target = os.getcwd()+'/test_%s_%s.grb' % (date[:10], time[:2])
...
#         "type": "pf",   
#         "grid": 'F640', #O1280
#         "area": "40/-20/-40/60", #Specify as North/West/South/East in Geographic lat/long degrees. Southern latitudes and Western longitudes must be given as negative numbers.
#         },
#         target)
