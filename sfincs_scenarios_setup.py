...
if __name__ == "__main__":
    ...
    # data and libraries
    data_libs = ['d:/paper_4/data/data_catalogs/data_catalog_converter.yml',
                 root_folder+f'data_deltares_{storm}/data_catalog.yml']
    
    list_indices_storm = ['merit_hydro','gebco', 'osm_coastlines', 'osm_landareas', 
                          'gswo', 'fabdem', 'dtu10mdt', 'gcn250', 'vito', "rivers_lin2019_v1"]
